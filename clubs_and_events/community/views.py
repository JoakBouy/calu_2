...
from community.permissions import IsStudent, IsLecturer, IsPubliclyVisible, IsLeaderOfCommunity, \
    IsDeputyLeaderOfCommunity, IsDeletableClub, IsDeletableLab
...
class ClubViewSet(viewsets.ModelViewSet):
    ...
    def get_permissions(self):
        if self.request.method == 'GET':
            ...
            return (permissions.IsAuthenticated(), IsLeaderOfCommunity(), IsDeletableClub())
        return tuple()
...
class LabViewSet(viewsets.ModelViewSet):
    ...
    def get_permissions(self):
        if self.request.method == 'GET':
            ...
            return (permissions.IsAuthenticated(), IsLeaderOfCommunity(), IsDeletableLab())
        return tuple()
